...
const LegalNotice = () => {
  return (
    <SimpleContentPage>
      ...
      <p>"La Maison Numérique de l'Austisme" est édité par la Fabrique Numérique des Ministères sociaux.</p>
      <ul>
      ...
      <p>
        ...
        site, merci de nous en faire part. Si vous n’obtenez pas de réponse rapide de notre part, vous êtes en droit de
      ...
      <p>
        ...
        <a href="http://references.modernisation.gouv.fr/accessibilite-numerique" target="_blank" rel="noreferrer">
