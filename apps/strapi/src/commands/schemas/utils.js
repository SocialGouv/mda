...
const toTypeLiteral = data => {
  ...
  const props = entries.reduce((acc, [key, value]) => {
    ...
    return [
      ...acc,
      // factory.createPropertyDeclaration(undefined, undefined, identifier, undefined, toTypeLiteral(value)),
      factory.createPropertySignature(undefined, identifier, undefined, toTypeLiteral(value), undefined),
    ];
  }, []);
