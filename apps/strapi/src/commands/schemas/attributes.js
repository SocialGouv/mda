...
const getAttributeModifiers = attribute => {
  ...
  if (attribute.configurable) {
    ...
    modifiers.push(factory.createTypeReferenceNode(factory.createIdentifier("ConfigurableAttribute")));
  }
  ...
  if (attribute.customField) {
    ...
    modifiers.push(factory.createTypeReferenceNode(factory.createIdentifier("CustomField"), typeArguments));
  }
  ...
  if (!_.isNil(attribute.min) || !_.isNil(attribute.max)) {
    ...
    modifiers.push(
      factory.createTypeReferenceNode(factory.createIdentifier("SetMinMax"), [toTypeLiteral(minMaxProperties)]),
    );
  }
  ...
  if (!_.isNil(attribute.minLength) || !_.isNil(attribute.maxLength)) {
    ...
    modifiers.push(
      factory.createTypeReferenceNode(factory.createIdentifier("SetMinMaxLength"), [toTypeLiteral(minMaxProperties)]),
    );
  }
  ...
  if (!_.isNil(attribute.default)) {
    ...
    modifiers.push(factory.createTypeReferenceNode(factory.createIdentifier("DefaultTo"), [defaultLiteral]));
  }
